...
- **Self-Explanatory Code**: Write code that explains _what_ it does.
- **Why, Not What**: Comments should explain _why_ a decision was made, not what the code is doing.
