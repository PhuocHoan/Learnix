      ...
      <div className="relative z-10 w-full max-w-4xl animate-fade-in">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-4">
            ...
            <span className="text-sm font-medium text-primary">Welcome aboard!</span>
          </div>
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          >
            ...
            <span className="relative z-10 flex items-center gap-3">
              {isSubmitting ? (
                ...
                <>
                  Continue as {selectedRole === 'instructor' ? 'Instructor' : selectedRole === 'student' ? 'Student' : '...'}
          ...
          <p className="text-center text-sm text-muted-foreground max-w-md">
            <span className="inline-flex items-center gap-1.5">
              ...
              Don't worry, you can switch between roles anytime from your settings.
            </span>
          </p>
        </div>
      </div>
