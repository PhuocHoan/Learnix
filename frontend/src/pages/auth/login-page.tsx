      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-primary relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
          ...
          <p className="text-lg text-white/80 text-center max-w-md leading-relaxed">
            Join thousands of learners mastering new skills with AI-powered quizzes and personalized learning paths.
          </p>
          ...
          <div className="glass rounded-2xl p-8 shadow-xl">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span className="font-medium text-sm group-hover:text-primary transition-colors">Google</span>
              </button>
