...
import { Users, BarChart3, BookOpen, Shield, ArrowRight, Sparkles } from 'lucide-react';
  ...
  const adminCards = [
    {
      ...
      description: 'View, edit roles, and manage user accounts across the platform',
      icon: Users,
      href: '/admin/users',
      ...
      <div className="relative overflow-hidden rounded-2xl gradient-primary p-8 text-white">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/80 max-w-xl">
            Manage users, monitor system activity, and oversee platform operations from this central hub.
          </p>
        </div>
      </div>
