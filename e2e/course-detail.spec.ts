...
test.describe('Course Detail Page', () => {
  ...
  test('should show locked lessons for guest users', async ({ page }) => {
    ...
    // Updated selector to be more specific to lucide icons
    const lockIcons = page.locator('.lucide-lock');
...
test.describe('Course Detail - Guest Interactions', () => {
  test('should show auth modal when clicking locked lesson', async ({
    ...
    // Try clicking a locked lesson. Use the updated selector
    const lockedLesson = page.locator('button:has(.lucide-lock)').first();
